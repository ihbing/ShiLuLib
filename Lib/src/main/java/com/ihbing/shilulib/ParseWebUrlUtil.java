...
public class ParseWebUrlUtil {
    private static ParseWebUrlUtil parseWebUrlUtil;
    ...
    //实现单例模式
    public static ParseWebUrlUtil getInstance() {
        if (parseWebUrlUtil == null) parseWebUrlUtil = new ParseWebUrlUtil();
        return parseWebUrlUtil;
    }

    public ParseWebUrlUtil init(Activity act, String url) {
        this.mAct = act;
        this.webUrl = url;
    ...
    public ParseWebUrlUtil setLoadUrl(String url){
        this.webUrl=url;
        return this;
    }
    public ParseWebUrlUtil startParse(){
        webView.loadUrl(this.webUrl);
        return this;
    }
    public ParseWebUrlUtil setOnParseListener(OnParseWebUrlListener onParseListener) {
